Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/PhonePe/BGFramework'
  s.author           = { 'Shridhara V' => 'shridhara.v@phonepe.com' }
  s.source           = { :git => 'https://github.com/PhonePe/BGFramework.git', :tag => s.version.to_s }
  ...
  s.subspec 'Core' do |core|
    core.source_files = 'BGFramework/Core/Classes/**/*.{swift,h,m}'
    core.resources = "BGFramework/Core/Assets/*.xcdatamodeld"
  end
