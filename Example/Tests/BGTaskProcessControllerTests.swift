...
class BGTaskProcessControllerTests: SenpaiSpecs {
    
    override func specs() {
        arena("BGTaskProcessController Tests") {
            beforeEachTest {
                self.beforeEachTestSetup()
            }
            
            test("inputs:registeredUsecases empty") {
            ...
            test("inputs:categories empty and registeredUsecases empty") {
                waitUntil(timeout: testTimeout) { done in
                    let configuration = BGConfigurationProvider.RegistrationData(permittedIdentifiers: [BGTaskSchedulerType.appRefreshTask: "com.phonepe"])
                    self.taskProcessController = BGTaskProcessController(categories: [],
                                                                         registeredUsecases: [],
            ...
            test("inputs:categories=connectivityTasks,requiresNetworkConnectivity=false") {
                waitUntil(timeout: testTimeout) { done in
                    var usecase1Called = false
                    let identifier1 = "id_1"
                    let usecase1 = BGSyncRegistrationData(
            ...
            test("inputs:categories=connectivityTasks,requiresNetworkConnectivity=true") {
                waitUntil(timeout: testTimeout) { done in
                    var usecase1Called = false
                    let identifier1 = "id_1"
                    let usecase1 = BGSyncRegistrationData(
            ...
            test("inputs:categories=connectivityTasks,requiresNetworkConnectivity_true=1,requiresNetworkConnectivity_false=1") {
                waitUntil(timeout: testTimeout) { done in
                    var usecase1Called = false
                    let identifier1 = "id_1"
                    let usecase1 = BGSyncRegistrationData(
            ...
            test("inputs:categories=withoutConnectivityTasks,requiresNetworkConnectivity_true=1,requiresNetworkConnectivity_false=1") {
                waitUntil(timeout: testTimeout) { done in
            ...
            test("inputs:categories=[connectivityTasks,withoutConnectivityTasks],requiresNetworkConnectivity_true=1,requiresNetworkConnectivity_false=1") {
                waitUntil(timeout: testTimeout) { done in
                    var usecase1Called = false
                    let identifier1 = "id_1"
                    let usecase1 = BGSyncRegistrationData(
